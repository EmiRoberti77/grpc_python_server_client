...
# added path manually for import relative to the project
import src.app.generated.proto_pb2 as proto__pb2
...
def add_EmiServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'emi_service.EmiService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('emi_service.EmiService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class EmiService(object):
    """Missing associated documentation comment in .proto file."""
